...
class IBMCOS:
    ...
    def save_object_in_cos(self, obj, name, timestamp, bucket_name='modulo-4-jessicaurrutia-bucket'):
        """
        ...
        try:
            ...
            print("KEY bucket: {} key: {}".format(bucket_name, pkl_key))
            print("CLIENT ERROR: {0}\n".format(be))
        except Exception as e:
            print("Unable to create object: {0}".format(e))

    def get_object_in_cos(self, key, bucket_name='modulo-4-jessicaurrutia-bucket'):
        """
